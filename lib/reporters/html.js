((typeof define === "function" && define.amd && function (m) {
    ...
    function initializeDoc(doc, title) {
        ...
        return {
            stats: doc.getElementsByClassName("btn-group")[0],
            progressBar: {
                container: doc.getElementsByClassName("progress")[0],
                pending: doc.getElementsByClassName("bar-info")[0],
                success: doc.getElementsByClassName("bar-success")[0],
                error: doc.getElementsByClassName("bar-warning")[0],
                failure: doc.getElementsByClassName("bar-danger")[0]
            },
            runContainer: doc.getElementsByClassName("test-results")[0],
            timing: doc.getElementsByClassName("muted")[0],
            randomSeed: doc.getElementsByClassName("muted")[1]
        };
    }
