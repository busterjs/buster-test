    ...
    B.testRunner = B.extend(B.create(B.eventEmitter), {
        ...
        run: function (context) {
            ...
            if (this.handleUncaughtExceptions) {
                catchUncaughtExceptions(buster.bind(this, "emit", "uncaughtException"));
            }
