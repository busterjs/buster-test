...
(function (B, when) {
    ...
    function checkAssertions(runner, expected, isAsync) {
        if (runner.failOnNoAssertions && runner.assertionCount() === 0 && !isAsync) {
