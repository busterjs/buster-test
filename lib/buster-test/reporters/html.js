((typeof define === "function" && define.amd && function (m) {
    define(["stack-filter"], m);
       ...
       typeof require === "function" && function (m) {
           ...
           module.exports = m(require("stack-filter"), jsdom, true);
    }) || function (m) {
        this.buster = this.buster || {};
        this.buster.reporters = this.buster.reporters || {};
        this.buster.reporters.html = m(this.stackFilter);
    }
)(function (stackFilter, jsdom, isNodeJS) {
    "use strict";
    ...
    function addException(li, error) {
        ...
        var stack = stackFilter(error.stack) || [];
    ...
    function HtmlReporter(opt) {
        ...
        this.io = opt.io || (isNodeJS && require("util"));
    }

    var htmlReporter = HtmlReporter.prototype = {
        create: function (opt) {
