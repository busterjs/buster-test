...
(function (B) {
    ...
    buster.consoleReporter = {
        ...
        create: function (runner, opt) {
            ...
            runner.on("suite:start", B.util.bind(reporter, "reset"));
            runner.on("suite:end", B.util.bind(reporter, "printDetails"));
            ...
            runner.on("test:fail", B.util.bind(reporter, "testFailure"));
            reporter.reset();
